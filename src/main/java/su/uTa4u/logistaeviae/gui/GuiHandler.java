...
import su.uTa4u.logistaeviae.gui.gui.GuiProviderPipe;
import su.uTa4u.logistaeviae.gui.gui.GuiSupplierPipe;
...
public final class GuiHandler implements IGuiHandler {
    ...
    private final Int2ObjectMap<BiFunction<InventoryPlayer, TileEntityPipe, Container>> serverGuiById = new Int2ObjectArrayMap<>();
    ...
    private void registerGui(
            int ID,
            BiFunction<InventoryPlayer, TileEntityPipe, Container> serverSupplier,
